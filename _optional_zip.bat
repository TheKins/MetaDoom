...
set NAME=metadoom-optional_test_%date:~-4,4%%date:~-7,2%%date:~-10,2%
echo ZDoom Mod Builderer
echo Originally by Kyle873 for Laughing Chamber
echo based on 7-Zip, (c) 1999-2010 Igor Pavlov
echo.
echo This will zip up the "metadoom-optional-dev" folder for external use (testers, release etc.)
set /p TYPE="Would you like to build a PK3 or PK7? (default pk3): " % = %

cd metadoom-optional-dev
